...
{
    /// <summary>
    /// Represents the important statuses for an Correspondence, used in migration and sync from Altinn 2 to Altinn 3
    /// </summary>
    public enum MigrateCorrespondenceStatusExt : int
    {
        /// <summary>
        ...
        /// <summary>
        /// Correspondence has been soft deleted by recipient in Altinn 2
        /// </summary>
        SoftDeletedByRecipient = 13,
