...
{
    /// <summary>
    /// Represents the request object used as input to the GetCorrespondenceStatusDetailsV3 operation in the CorrespondenceAgency service.
    ...
    public class CorrespondenceStatusFilterExternalBEV3
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public SdpStatusSearchOptionsExternalBE SdpSearchOptions { get; set; }
    }
}
