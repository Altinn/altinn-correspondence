...
namespace Altinn.Correspondence.Core.Repositories
{
    public interface IAttachmentRepository
    {
        ...
        Task<string> SetDataLocationUrl(AttachmentEntity attachmentEntity, AttachmentDataLocationType attachmentDataLocationType, string dataLocationUrl, CancellationToken cancellationToken);
        Task<string> SetChecksum(AttachmentEntity attachmentEntity, string? checksum, CancellationToken cancellationToken);
