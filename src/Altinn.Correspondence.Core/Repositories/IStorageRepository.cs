...
namespace Altinn.Correspondence.Core.Repositories
{
    ...
    {
        Task<(string locationUrl, string hash, long size)> UploadAttachment(AttachmentEntity attachment, Stream stream, long streamLength, StorageProviderEntity? storageProviderEntity, CancellationToken cancellationToken);
