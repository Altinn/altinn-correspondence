...
public static class CorrespondenceErrors
{
    ...
    public static Error RecipientLacksRequiredRolesForCorrespondence(List<string> recipients) { return new Error(1044, $"The following recipients lacks required roles to read the correspondence: {string.Join(", ", recipients)}", HttpStatusCode.BadRequest); }
}
