...
public static class CorrespondenceErrors
{
    ...
    public static Error RecipientReserved(string recipientId) => new Error(1029, $"Recipient {recipientId} has reserved themselves from public correspondences. Can be overridden using the 'IgnoreReservation' flag.", HttpStatusCode.UnprocessableEntity);
}
