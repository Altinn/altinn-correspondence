...
public static class AttachmentErrors
{
    ...
    public static Error DelegatedSasNotSupported = new Error(2024, "User delegation SAS is not supported for this storage configuration", HttpStatusCode.BadRequest);
}
