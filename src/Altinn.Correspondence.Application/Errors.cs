...
public static class CorrespondenceErrors
{
    ...
    public static Error FailureWhenLookingUpKRR = new Error(1031, $"Failed looking up recipients in the contact reservation regisry (KRR)", HttpStatusCode.BadGateway);
}
