...
module saveMigrationConnectionString '../keyvault/upsertSecret.bicep' = {	
  ...
  params: {	
    ...
    secretValue: 'Host=${postgres.properties.fullyQualifiedDomainName};Database=${databaseName};Port=5432;Username=${namePrefix}-migration-identity;Ssl Mode=Require;Maximum Pool Size=5;options=-c role=azure_pg_admin;'	
  }	
}
