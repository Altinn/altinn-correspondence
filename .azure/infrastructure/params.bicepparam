...
param storageAccountSku = readEnvironmentVariable('STORAGE_ACCOUNT_SKU')
param correspondenceBlobGroupId = readEnvironmentVariable('CORRESPONDENCE_BLOB_GROUP_ID')
