...
param backupIdentityResourceId = readEnvironmentVariable('BACKUP_IDENTITY_RESOURCE_ID')
param backupIdentityClientId = readEnvironmentVariable('BACKUP_IDENTITY_CLIENT_ID')
param backupIdentityPrincipalId = readEnvironmentVariable('BACKUP_IDENTITY_PRINCIPAL_ID')
param backupIdentityName = readEnvironmentVariable('BACKUP_IDENTITY_NAME')
